...
//import passwordEyeSlash from './assets/password-eye-slash.png';
...
function SignUp() {
  ...
  const handleSignUp = (e) => {
    ...
    navigate('/account-completion'); // ✅ Navigate to Account Completion screen
  };
    ...
    >
      ...
      <div className="flex justify-center items-center flex-1">
        <motion.form 
          ...
          onSubmit={handleSignUp} // ✅ Attach function to form submission
        >
          <motion.img 
            src={logo} 
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="rememberMe" className="ml-2 block text-sm text-gray-900 transition-all">Agree to the terms and conditions</label>
          </div>
