...
function OTP() {
  ...
  const handleVerify = () => {
    ...
    if (enteredOtp === "123456") { // Replace with actual OTP validation logic
      navigate('/secure-account'); // Redirect to Secure Account Page
    } else {
      ...
      <div className="flex justify-center items-center flex-1">
        ...
        >
          ...
          <p className="text-center text-gray-600 px-6">
            Check your email and enter the OTP code that was sent to you in order to reset your password.
          </p>
          ...
          <div className="flex space-x-2">
            {otp.map((data, index) => (
              <input
                ...
                type="text"
                maxLength="1"
                className="w-12 h-12 text-center border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-all"
                value={data}
          ...
          {/* Resend Code Section */}
          <p className="text-gray-500 text-sm">You can resend the code in 30s</p>
          <span className="text-amber-500 underline cursor-pointer hover:text-amber-600 transition-all text-sm font-bold">
            Resend
          </span>
