...
import { FaUser, FaTools, FaPhone, FaEye, FaEyeSlash } from "react-icons/fa";
    ...
    >
      ...
      >
        ...
        <div className="relative w-full">
          <label htmlFor="name" className="absolute left-10 top-3 text-gray-500 text-sm transition-all">Name</label>
        ...
        {/* Skills Input */}
        <div className="relative w-full">
          <label htmlFor="skills" className="absolute left-10 top-3 text-gray-500 text-sm transition-all">Skills</label>
          <div className="relative flex items-center border border-gray-300 rounded-md shadow-sm">
